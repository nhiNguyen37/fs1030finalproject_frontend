    ...
    return (
      ...
      <Jumbotron >
        ...
        <Col lg="5">
            ...
            <Button color="info" className="hero-button" href="/resume" Text style={{color: 'black'}}>See More</Button>
        </Col>
    </Row>
    </Jumbotron>
      ...
      <Jumbotron>
        ...
        <p>I might lack the background in Technology or Design but I'm constantly learning new things and gaining more experience as well as challenging myself with new things including MongoDB, React, Express JS, and Node JS. </p>
        <p>My latest project is ERMSystem. Check it out <a href="https://gitlab.com/york-u-s21-fs1030-group-d-course-project" target="_blank" rel="noopener noreferrer">here</a>, or on the portfolio page.</p>
        <p> For more information?</p>
        <Button color="warning" Text style={{color: 'black'}} href="/portfolio">Click Here</Button>
